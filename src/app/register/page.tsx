...
export default function FaceLandmarkDemo() {
  ...
  function updateBlinkUI() {
    ...
    switch (testStatus) {
      ...
      case 'passed':
        ...
        testStatusRef.current.innerHTML = '<span class="text-green-600">✅ REGISTRATION APPROVED - BLINK TEST PASSED</span>'
        break
    }
  }
  ...
  function updateHeadTurnUI() {
    ...
    switch (testStatus) {
      ...
      case 'passed':
        testInstructionRef.current.innerHTML = '<b>🎉 Verification Successful!</b>'
        testStatusRef.current.innerHTML = '<span class="text-green-600">✅ REGISTRATION APPROVED - HEAD TURN TEST PASSED</span>'
        break
    }
  }
  ...
  function updateNodUI() {
    ...
    switch (testStatus) {
      ...
      case 'passed':
        testInstructionRef.current.innerHTML = '<b>🎉 Verification Successful!</b>'
        testStatusRef.current.innerHTML = '<span class="text-green-600">✅ REGISTRATION APPROVED - NOD TEST PASSED</span>'
        break
    }
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-black/80">
            Complete face liveness verification to create your account
          </p>
        </div>
            ...
            <div className="text-center">
              ...
              {faceRecognitionError && (
                <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <p className="text-red-600 text-xs mt-1">Redirecting to manual registration...</p>
                </div>
              )}
