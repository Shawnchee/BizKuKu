      ...
      >
          ...
          <Card className="mb-8 p-8 rounded-2xl shadow-lg border border-gray-200 bg-white">
            ...
            >
              ...
              <motion.div 
                ...
                animate="visible"
              >
                {preferenceOptions.map((opt, index) => (
                  <motion.button
                    key={opt.value}
                    type="button"
        ...
        <AnimatePresence>
          {!recommendations.length && !isThinking && (
            ...
            >
              ...
              >
                <motion.div 
                  className="flex items-center gap-2 text-green-700 font-semibold bg-green-50 px-3 py-1 rounded-lg"
                  variants={itemVariants}
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.2 }}
                >
                ...
                <motion.div 
                  className="flex items-center gap-2 text-blue-700 font-semibold bg-blue-50 px-3 py-1 rounded-lg"
                  variants={itemVariants}
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.2 }}
                >
                ...
                <motion.div 
                  className="flex items-center gap-2 text-yellow-700 font-semibold bg-yellow-50 px-3 py-1 rounded-lg"
                  variants={itemVariants}
                  whileHover={{ scale: 1.05 }}
                  transition={{ duration: 0.2 }}
                >
        ...
        <AnimatePresence>
          {(!isThinking && recommendations.length > 0) && (
            ...
            >
              <motion.h2 
                className="text-2xl font-bold mb-4 text-blue-900 flex items-center gap-2"
              ...
              >
                ...
                {[grantsAndLoans[6], grantsAndLoans[8], subsidiesAndSchemes[0]].map((rec, idx) => (
                  <motion.div 
                    key={rec.id} 
                    className="bg-white border-2 border-blue-300 rounded-2xl shadow-lg p-6 flex flex-col h-full relative"
