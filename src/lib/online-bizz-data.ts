...
export interface ConsolidatedStats {
  today: { totalRevenue: number; totalOrders: number; totalCustomers: number; totalProducts: number }
  last7days: { totalRevenue: number; totalOrders: number; totalCustomers: number; totalProducts: number }
  last1month: { totalRevenue: number; totalOrders: number; totalCustomers: number; totalProducts: number }
  alltime: { totalRevenue: number; totalOrders: number; totalCustomers: number; totalProducts: number }
...
export const quickStartGuides: Guide[] = [
  {
    id: "photography-tips",
...
export const categories = ["all", "E-commerce Marketplace", "Social Commerce", "Food Delivery"]